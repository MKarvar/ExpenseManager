...
namespace ExpenseManager.Infrastructure.Migrations
{
    ...
    [Migration("20220726224747_change_field_name2")]
    partial class change_field_name2
    {
            ...
            modelBuilder.Entity("ExpenseManager.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDateTime = new DateTime(2022, 7, 27, 3, 17, 46, 754, DateTimeKind.Local).AddTicks(7425),
                            SecurityStamp = new Guid("4a454c37-99ae-43ed-9cd0-59e919d45e7a"),
                            Username = "MKarvar"
                        });
                });
