...
namespace ExpenseManager.Infrastructure.Migrations
{
    ...
    [Migration("20220726215351_change_field_names")]
    partial class change_field_names
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpenseManager.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDateTime = new DateTime(2022, 7, 27, 2, 23, 50, 816, DateTimeKind.Local).AddTicks(9810),
                            SecurityStamp = new Guid("b94cb8c0-352c-4430-9d6e-b0070377f3da"),
                            Username = "MKarvar"
                        });
                });
            ...
            modelBuilder.Entity("ExpenseManager.Domain.Entities.Expense", b =>
                {
                    b.Navigation("ExpenseTakeParters");
                });
