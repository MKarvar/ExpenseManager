        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastUpdatorId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Events_Users_LastUpdatorId",
                        column: x => x.LastUpdatorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Food", null },
                    { 2, "Hotel", null },
                    { 3, "AirplaneTicket", null }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "IsActive", "LastLoginDate", "LastUpdatedDate", "PasswordHash", "RegistrationDateTime", "SecurityStamp", "Username" },
                values: new object[] { 1, true, null, null, "jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=", new DateTime(2022, 7, 27, 1, 49, 26, 40, DateTimeKind.Local).AddTicks(827), new Guid("d83ea151-9d27-4803-a7e9-9b6ae9f29138"), "MKarvar" });
