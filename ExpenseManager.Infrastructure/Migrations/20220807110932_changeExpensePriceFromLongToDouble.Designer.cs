...
namespace ExpenseManager.Infrastructure.Migrations
{
    ...
    [Migration("20220807110932_changeExpensePriceFromLongToDouble")]
    partial class changeExpensePriceFromLongToDouble
    {
            ...
            modelBuilder.Entity("ExpenseManager.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDateTime = new DateTime(2022, 8, 7, 15, 39, 31, 713, DateTimeKind.Local).AddTicks(624),
                            SecurityStamp = new Guid("47d3580d-c2ab-4e32-a217-e13021e77da5"),
                            Username = "MKarvar"
                        });
                });
