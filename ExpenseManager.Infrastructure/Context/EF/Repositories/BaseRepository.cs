...
namespace ExpenseManager.Infrastructure.Context.EF.Repositories
{
    ...
    {
        protected readonly ExpenseManagerDBContext DbContext;
        ...
        public BaseRepository(ExpenseManagerDBContext dbContext)
        {
            DbContext = dbContext;
        ...
        {
            var t =  await Entities.FindAsync(ids, cancellationToken);
            return t;
        }
